...
namespace PhanMen_BanHang.Class
{
    internal class Functions
    {
        ...
        //Phương thức thực hiện câu lệnh Selct (Lấy dữ liệu Sql)
        public static DataTable GetDataToTable (string sql)
        {
            con = new SqlConnection();
            con.ConnectionString = Properties.Settings.Default.CSDL_BanHangConnetionString;
            SqlDataAdapter dap = new SqlDataAdapter();  //Định nghĩa đối tượng thuộc lớp DataAdapter
            //Khai báo đối tượng thuộc lớp SqlCommand
            dap.SelectCommand = new SqlCommand();
            dap.SelectCommand.Connection = Functions.con;   //Kết nối cơ sở dữ liệu
            dap.SelectCommand.CommandText = sql;        //Lệnh SQL
            //Khai báo đối tượng thuốc lớp DataTable
        ...
        public static void RunSQL(string sql)
        {
            ...
            cmd = new SqlCommand();
            cmd.Connection = Functions.con; // Gán kết nối CSDL
        ...
        //Hàm tạo khóa có dạng => Tiền tố => Ngaythangnam_giophutgiay
        ...
        public static string CreatekeysMa(string tiento)
        {
            string key = tiento;
            string[] partsDay;
            string[] partsTime;
        ...
        private static string ConvertTimeTo24(string v)
        {
            string h = "";
            switch (v)
            {
        ...
        //1,123,000 => một triệu một trăm hai ba nghin đồng
        //1,123,345,000 => một tỷ một trăm hai ba triệu ba trăm bồn lăm ngàn đồng
